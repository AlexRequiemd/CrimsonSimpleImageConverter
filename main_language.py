...
def resource_path(relative_path): # https://stackoverflow.com/questions/31836104/pyinstaller-and-onefile-how-to-include-an-image-in-the-exe-file
	'''Pega o caminho absoluto para o resource, para o pyinstaller'''
	try:
...
"""
data = json.load(open(resource_path('data/data.json'), 'r', encoding='utf-8'))
...
opt_output2_txt = [translate_dict['text_17'][0], translate_dict['text_17'][1], translate_dict['text_17'][2], translate_dict['text_17'][3]]
...
dlg_info_txt = translate_dict['text_38'][0] + translate_dict['text_38'][1] + translate_dict['text_38'][2] + translate_dict['text_38'][3] + translate_dict['text_38'][4]
#set_alreadyexistent_file()------------------------------------
rep_options = opt_output2_txt #usar: rep_options[0] ou rep_options[1] ou rep_options[2] ou rep_options[3]
#extract_image_info()------------------------------------------
